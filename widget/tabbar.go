...
func X创建TAB条(元素x坐标 int, 元素y坐标 int, 宽度 int, 高度 int, 父窗口句柄或元素句柄 int) *TabBar {
	p := &TabBar{}
	p.X设置句柄(炫彩基类.XTAB条_创建(元素x坐标, 元素y坐标, 宽度, 高度, 父窗口句柄或元素句柄))
	return p
}
...
func (t *TabBar) X添加标签(标签文本 string) int {
	return 炫彩基类.XTAB条_添加标签(t.Handle, 标签文本)
}
...
func (t *TabBar) XTAB条插入_标签(插入位置 int, 标签文本 string) int {
	return 炫彩基类.XTAB条插入_标签(t.Handle, 插入位置, 标签文本)
}
...
func (t *TabBar) X移动标签(源位置索引 int, 目标位置索引 int) bool {
	return 炫彩基类.XTAB条_移动标签(t.Handle, 源位置索引, 目标位置索引)
}
...
func (t *TabBar) X删除标签(位置索引 int) bool {
	return 炫彩基类.XTAB条_删除标签(t.Handle, 位置索引)
}

// TAB条_删除全部, 删除所有标签.
func (t *TabBar) X删除全部() int {
	return 炫彩基类.XTAB条_删除全部(t.Handle)
}
...
func (t *TabBar) X取标签(位置索引 int) int {
	return 炫彩基类.XTAB条_取标签(t.Handle, 位置索引)
}
...
func (t *TabBar) X取标签上的关闭按钮(位置索引 int) int {
	return 炫彩基类.XTAB条_取标签上的关闭按钮(t.Handle, 位置索引)
}

// TAB条_取左滚动按钮, 获取左滚动按钮句柄.
func (t *TabBar) X取左滚动按钮() int {
	return 炫彩基类.XTAB条_取左滚动按钮(t.Handle)
}

// TAB条_取右滚动按钮, 获取右滚动按钮句柄.
func (t *TabBar) X取右滚动按钮() int {
	return 炫彩基类.XTAB条_取右滚动按钮(t.Handle)
}

// TAB条_取下拉菜单按钮句柄.
func (t *TabBar) X取下拉菜单按钮句柄() int {
	return 炫彩基类.XTAB条_取下拉菜单按钮句柄(t.Handle)
}

// TAB条_取当前选择, 获取选择的标签索引.
func (t *TabBar) X取当前选择() int {
	return 炫彩基类.XTAB条_取当前选择(t.Handle)
}

// TAB条_取间隔, 获取标签间距, 0没有间距.
func (t *TabBar) X取间隔() int {
	return 炫彩基类.XTAB条_取间隔(t.Handle)
}

// TAB条_取标签数量, 获取标签项数量.
func (t *TabBar) X取标签数量() int {
	return 炫彩基类.XTAB条_取标签数量(t.Handle)
}
...
func (t *TabBar) X取标签位置索引(标签按钮句柄 int) int {
	return 炫彩基类.XTAB条_取标签位置索引(t.Handle, 标签按钮句柄)
}
...
func (t *TabBar) X置间隔(标签间隔大小 int) int {
	return 炫彩基类.XTAB条_置间隔(t.Handle, 标签间隔大小)
}
...
func (t *TabBar) X置边距(左 int, 上 int, 右 int, 下 int) int {
	return 炫彩基类.XTAB条_置边距(t.Handle, 左, 上, 右, 下)
}
...
func (t *TabBar) X置选择(索引 int) int {
	return 炫彩基类.XTAB条_置选择(t.Handle, 索引)
}

// TAB条_左滚动, 左按钮滚动.
func (t *TabBar) X左滚动() int {
	return 炫彩基类.XTAB条_左滚动(t.Handle)
}

// TAB条_右滚动, 右按钮滚动.
func (t *TabBar) X右滚动() int {
	return 炫彩基类.XTAB条_右滚动(t.Handle)
}
...
func (t *TabBar) X启用平铺(是否启用 bool) int {
	return 炫彩基类.XTAB条_启用平铺(t.Handle, 是否启用)
}
...
func (t *TabBar) X启用下拉菜单按钮(是否启用 bool) int {
	return 炫彩基类.XTAB条_启用下拉菜单按钮(t.Handle, 是否启用)
}
...
func (t *TabBar) X启用标签带关闭按钮(是否启用 bool) int {
	return 炫彩基类.XTAB条_启用标签带关闭按钮(t.Handle, 是否启用)
}
...
func (t *TabBar) X置关闭按钮大小(大小值 *炫彩基类.SIZE) int {
	return 炫彩基类.XTAB条_置关闭按钮大小(t.Handle, 大小值)
}
...
func (t *TabBar) X置滚动按钮大小(大小值 *炫彩基类.SIZE) int {
	return 炫彩基类.XTAB条_置滚动按钮大小(t.Handle, 大小值)
}
...
func (t *TabBar) X置指定标签固定宽度(索引 int, 宽度 int) int {
	return 炫彩基类.XTAB条_置指定标签固定宽度(t.Handle, 索引, 宽度)
}
...
func (t *TabBar) X显示标签(标签索引 int, 是否显示 bool) bool {
	return 炫彩基类.XTAB条_显示标签(t.Handle, 标签索引, 是否显示)
}

...
// 置指定行高度, 类型为 Edit_Type_Richedit 支持指定不同行高.
//
// iRow: 行索引.
//
// nHeight: 高度.
...
// 置后备字体, 置中文字体. 如果已设置, 当遇到中文字符时使用后备字体, 解决不支持中文的字体的问题
//
// hFont: 字体.
...
// 取临时文本, 不包含非文本内容. 返回临时文本, 临时缓存区大小: xcc.Text_Buffer_Size .
func (e *Edit) GetText_Temp() string {
	return xc.XEdit_GetText_Temp(e.Handle)
}

// 取临时文本行, 获取指定行文本内容. 返回临时文本, 临时缓存区大小: xcc.Text_Buffer_Size .
//
// iRow: 行索引.
...
// 取选择文本, 不包含非文本内容. 返回临时文本, 临时缓存区大小: xcc.Text_Buffer_Size .
...
type XE_EDIT_CHANGED func(pbHandled *bool) int                                   //内容被改变.
type XE_EDIT_CHANGED1 func(hEle int, pbHandled *bool) int                        //内容被改变.
type XE_EDIT_POS_CHANGED func(iPos int32, pbHandled *bool) int                   //光标位置_被改变.
type XE_EDIT_POS_CHANGED1 func(hEle int, iPos int32, pbHandled *bool) int        //光标位置_被改变.
type XE_EDIT_STYLE_CHANGED func(iStyle int32, pbHandled *bool) int               //样式_被改变.
type XE_EDIT_STYLE_CHANGED1 func(hEle int, iStyle int32, pbHandled *bool) int    //样式_被改变.
...
type XE_EDIT_COLOR_CHANGE func(color int, pbHandled *bool) int                  //颜色被改变
type XE_EDIT_COLOR_CHANGE1 func(hEle int, color int, pbHandled *bool) int       //颜色被改变

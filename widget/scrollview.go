...
// 置视图大小, 设置内容大小, 如果内容改变返回TRUE否则返回FALSE.
// cx: 宽度.
// cy: 高度.
...
// 置滚动单位大小, 设置滚动单位大小, 如果内容改变返回TRUE否则返回FALSE.
// nWidth: 宽度.
// nHeight: 高度.
...
type XE_SCROLLVIEW_SCROLL_H func(pos int32, pbHandled *bool) int            //事件_水平滚动事件,滚动视图触发.
type XE_SCROLLVIEW_SCROLL_H1 func(hEle int, pos int32, pbHandled *bool) int //事件_水平滚动事件,滚动视图触发.
type XE_SCROLLVIEW_SCROLL_V func(pos int32, pbHandled *bool) int            //事件_垂直滚动事件,滚动视图触发.
type XE_SCROLLVIEW_SCROLL_V1 func(hEle int, pos int32, pbHandled *bool) int //事件_垂直滚动事件,滚动视图触发.

...
// 创建菜单条  创建菜单条元素; 如果指定了父为窗口, 默认调用XWnd_AddMenuBar()函数, 将菜单条添加到窗口非客户区.
// x: 元素x坐标.
// y: 元素y坐标.
// cx: 宽度.
// cy: 高度.
...
// 启用自动宽度, 根据内容自动调整宽度. (已废弃)请使用内填充限制高度
// bEnable: 是否启用.

...
func main() {
	...
	// 创建按钮
	btn1 = widget.I按钮_创建(20, 40, 100, 30, "浏览文件夹", w.I句柄)
	btn2 = widget.I按钮_创建(20, 80, 100, 30, "单选打开文件", w.I句柄)
	btn3 = widget.I按钮_创建(130, 80, 100, 30, "多选打开文件", w.I句柄)
	btn4 = widget.I按钮_创建(20, 120, 100, 30, "保存文件", w.I句柄)

	// 注册按钮事件
	btn1.I事件_按钮被单击1(onBnClick)
	btn2.I事件_按钮被单击1(onBnClick)
	btn3.I事件_按钮被单击1(onBnClick)
	btn4.I事件_按钮被单击1(onBnClick)

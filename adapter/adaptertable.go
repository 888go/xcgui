...
// 取项数据类型, 获取项数据类型, 返回: Adapter_Date_Type_.
// // iItem: 项索引.
// // iColumn: 列索引.
...
// 取项数据类型扩展, 返回: Adapter_Date_Type_.
// // iItem: 项索引.
// // pName: 字段称.

...
func (a *Anima) Move(duration int, x float32, y float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) MoveEx(duration int, from_x float32, from_y float32, to_x float32, to_y float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) Rotate(duration int, angle float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaRotate {
	p := &AnimaRotate{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) RotateEx(duration int, from float32, to float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaRotate {
	p := &AnimaRotate{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) Scale(duration int, scaleX float32, scaleY float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaScale {
	p := &AnimaScale{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) ScaleSize(duration int, width float32, height float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaScale {
	p := &AnimaScale{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) Alpha(duration int, alpha uint8, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) AlphaEx(duration int, from_alpha uint8, to_alpha uint8, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) Color(duration int, color int, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) ColorEx(duration int, from int, to int, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) LayoutWidth(duration int, nType 炫彩常量类.Layout_Size_, width float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) LayoutHeight(duration int, nType 炫彩常量类.Layout_Size_, height float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) LayoutSize(duration int, nWidthType 炫彩常量类.Layout_Size_, width float32, nHeightType 炫彩常量类.Layout_Size_, height float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) *AnimaItem {
	p := &AnimaItem{}
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func (a *Anima) DelayEx(duration float32, nLoopCount int, ease_flag 炫彩常量类.Ease_Flag_, bGoBack bool) int {

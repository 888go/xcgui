...
//	@param XCStyle:样式   xcc.Window_Style_.
...
// 消息框创建EX, 然后请调用 DoModal() 方法显示模态窗口.
// //	@param dwExStyle 窗口EX样式.
//
//	@param dwStyle: 窗口样式.
...
// 绘制, 在自绘事件函数中,用户手动调用绘制窗口, 以便控制绘制顺序.
// //hDraw: 图形绘制句柄.
...
// 取透明类型, 返回: xcc.Window_Transparent_.
...
// 通知消息_窗口中弹出EX, 使用基础元素作为面板, 弹出一个通知消息, 返回元素句柄, 通过此句柄可对其操作.
// //position: 位置, Position_Flag_.
// //pTitle: 标题.
// //pText: 内容.
// //hIcon: 图标.
...
// 置窗口位置. 封装系统API SetWindowPos(), 内部做了DPI适配.
// //hWndInsertAfter: 在Z序中位于定位窗口之前的窗口句柄. 此参数必须是窗口HWND或以下值之一: xcc.HWND_.
// //x: X坐标.
// //y: Y坐标.
// //cx: 宽度.
// //cy: 高度.
// //uFlags: 标志. 可以是以下值的组合: xcc.SWP_.
...
type XWM_WINDPROC func(message uint32, wParam, lParam uint, pbHandled *bool) int               //消息过程.
type XWM_WINDPROC1 func(hWindow int, message uint32, wParam, lParam uint, pbHandled *bool) int //消息过程.
...
type XWM_SETFOCUS_ELE func(hEle int, pbHandled *bool) int                                      //事件_置焦点元素. 指定元素获得焦点
type XWM_SETFOCUS_ELE1 func(hWindow int, hEle int, pbHandled *bool) int                        //事件_置焦点元素. 指定元素获得焦点
...
type XWM_PAINT_END func(hDraw int, pbHandled *bool) int                                        //绘制完成消息.
type XWM_PAINT_END1 func(hWindow int, hDraw int, pbHandled *bool) int                          //绘制完成消息.
type XWM_PAINT_DISPLAY func(pbHandled *bool) int                                               //绘制完成并且已经显示到屏幕.
type XWM_PAINT_DISPLAY1 func(hWindow int, pbHandled *bool) int                                 //绘制完成并且已经显示到屏幕.
...
type WM_PAINT func(hDraw int, pbHandled *bool) int                                        //绘制消息.
type WM_PAINT1 func(hWindow int, hDraw int, pbHandled *bool) int                          //绘制消息.
type WM_CLOSE func(pbHandled *bool) int                                                   //关闭消息.
type WM_CLOSE1 func(hWindow int, pbHandled *bool) int                                     //关闭消息.
type WM_DESTROY func(pbHandled *bool) int                                                 //销毁消息.
type WM_DESTROY1 func(hWindow int, pbHandled *bool) int                                   //销毁消息.
type WM_NCDESTROY func(pbHandled *bool) int                                               //非客户区销毁消息.
type WM_NCDESTROY1 func(hWindow int, pbHandled *bool) int                                 //非客户区销毁消息.
type WM_MOUSEMOVE func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int                   //鼠标移动消息.
type WM_MOUSEMOVE1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int     //鼠标移动消息.
type WM_LBUTTONDOWN func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int                 //鼠标左键按下消息.
type WM_LBUTTONDOWN1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int   //鼠标左键按下消息.
type WM_LBUTTONUP func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int                   //鼠标左键弹起消息.
type WM_LBUTTONUP1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int     //鼠标左键弹起消息.
type WM_RBUTTONDOWN func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int                 //鼠标右键按下消息.
type WM_RBUTTONDOWN1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int   //鼠标右键按下消息.
type WM_RBUTTONUP func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int                   //鼠标右键弹起消息.
type WM_RBUTTONUP1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int     //鼠标右键弹起消息.
type WM_LBUTTONDBLCLK func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int               //鼠标左键双击消息.
type WM_LBUTTONDBLCLK1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int //鼠标左键双击消息.
type WM_RBUTTONDBLCLK func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int               //鼠标右键双击消息.
type WM_RBUTTONDBLCLK1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int //鼠标右键双击消息.
type WM_MOUSEWHEEL func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int                  //鼠标滚轮滚动消息.
type WM_MOUSEWHEEL1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int    //鼠标滚轮滚动消息.
type WM_EXITSIZEMOVE func(pbHandled *bool) int                                            //退出移动或调整大小模式循环改，详情参见MSDN.
type WM_EXITSIZEMOVE1 func(hWindow int, pbHandled *bool) int                              //退出移动或调整大小模式循环改，详情参见MSDN.
type WM_MOUSEHOVER func(nFlags uint, pPt *xc.POINT, pbHandled *bool) int                  //鼠标进入消息.
type WM_MOUSEHOVER1 func(hWindow int, nFlags uint, pPt *xc.POINT, pbHandled *bool) int    //鼠标进入消息.
type WM_MOUSELEAVE func(pbHandled *bool) int                                              //鼠标离开消息.
type WM_MOUSELEAVE1 func(hWindow int, pbHandled *bool) int                                //鼠标离开消息.
type WM_SIZE func(nFlags uint, pPt *xc.SIZE, pbHandled *bool) int                         //大小改变消息.
type WM_SIZE1 func(hWindow int, nFlags uint, pPt *xc.SIZE, pbHandled *bool) int           //大小改变消息.
type WM_TIMER func(nIDEvent uint, pbHandled *bool) int                                    //定时器消息.
type WM_TIMER1 func(hWindow int, nIDEvent uint, pbHandled *bool) int                      //定时器消息.
type WM_SETFOCUS func(pbHandled *bool) int                                                //获得焦点.
type WM_SETFOCUS1 func(hWindow int, pbHandled *bool) int                                  //获得焦点.
type WM_KILLFOCUS func(pbHandled *bool) int                                               //失去焦点.
type WM_KILLFOCUS1 func(hWindow int, pbHandled *bool) int                                 //失去焦点.
type WM_KEYDOWN func(wParam, lParam uint, pbHandled *bool) int                            //键盘按键消息.
type WM_KEYDOWN1 func(hWindow int, wParam, lParam uint, pbHandled *bool) int              //键盘按键消息.
type WM_CAPTURECHANGED func(hWnd uintptr, pbHandled *bool) int                            //鼠标捕获改变消息.
type WM_CAPTURECHANGED1 func(hWindow int, hWnd uintptr, pbHandled *bool) int              //鼠标捕获改变消息.
type WM_SETCURSOR func(wParam, lParam uint, pbHandled *bool) int                          //设置鼠标光标.
type WM_SETCURSOR1 func(hWindow int, wParam, lParam uint, pbHandled *bool) int            //设置鼠标光标.
type WM_CHAR func(wParam, lParam uint, pbHandled *bool) int                               //字符消息.
type WM_CHAR1 func(hWindow int, wParam, lParam uint, pbHandled *bool) int                 //字符消息.
...
// 线程_炫彩定时器, 非系统定时器, 注册消息XWM_TIMER接收.
...
// 线程_框架窗口主视图坐标改变1, 如果主视图没有绑定元素, 那么当坐标改变时触发此事件.
...
// 线程_绘制菜单背景, 启用该功能需要调用XMenu_EnableDrawBackground().
...
// 线程_绘制菜单背景1, 启用该功能需要调用XMenu_EnableDrawBackground().
...
// 线程_绘制菜单项事件, 启用该功能需要调用XMenu_EnableDrawItem().
...
// 线程_绘制菜单项事件1, 启用该功能需要调用XMenu_EnableDrawItem().

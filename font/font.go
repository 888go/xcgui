...
//	@param pName 字体名称.
//	@param size 字体大小, 单位(pt,磅).
//	@param style 字体样式, xcc.I常量_字体样式_.
//	@return *Font 返回字体对象.
func NewFontEX(pName string, size int, style xcc.I常量_字体样式_) *Font {
	p := &Font{}
...
//	@param style 字体样式, xcc.I常量_字体样式_.
//	@return *Font 返回字体对象.
func NewFontFromFile(pFontFile string, size int, style xcc.I常量_字体样式_) *Font {
	p := &Font{}
...
func NewFontFromZip(pZipFileName, pFileName, pPassword string, fontSize int, style xcc.I常量_字体样式_) *Font {
	p := &Font{}
...
//	@param style 字体样式: xcc.I常量_字体样式_.
//	@return *Font 返回炫彩字体对象.
func NewFontFromZipMem(data []byte, pFileName, pPassword string, fontSize int, style xcc.I常量_字体样式_) *Font {
	p := &Font{}
...
//	@param style 字体样式, xcc.I常量_字体样式_.
//	@return *Font 返回字体对象.
func NewFontFromMem(data []byte, fontSize int, style xcc.I常量_字体样式_) *Font {
	p := &Font{}
...
//	@param hModule xx.
//	@return *Font 返回字体对象.
func NewFontFromRes(id int, pType string, fontSize int, style xcc.I常量_字体样式_, hModule int) *Font {
	p := &Font{}
...
func (f *Font) EnableAutoDestroy(bEnable bool) int {
	return xc.XFont_EnableAutoDestroy(f.I句柄, bEnable)
}
...
func (f *Font) GetFontInfo(pInfo *xc.Font_Info_) int {
	return xc.XFont_GetFontInfo(f.I句柄, pInfo)
}
...
func (f *Font) GetLOGFONTW(hdc int, pOut *xc.LOGFONTW) bool {
	return xc.XFont_GetLOGFONTW(f.I句柄, hdc, pOut)
}
...
func (f *Font) GetRefCount() int {
	return xc.XFont_GetRefCount(f.I句柄)
}

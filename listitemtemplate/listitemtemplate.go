...
func (l *ListItemTemplate) AddNodeRoot(pNode int) bool {
	return xc.XTemp_AddNodeRoot(l.I句柄, pNode)
}
...
func (l *ListItemTemplate) List_GetNode(index int) int {
	return xc.XTemp_List_GetNode(l.I句柄, index)
}
...
//
// nType: 对象类型: XC_.
func NewNode(nType xcc.I常量_对象句柄类型_) *Node {
	p := &Node{

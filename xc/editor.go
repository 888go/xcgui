...
func XEidtor_EnableAutoMatchSpaseSelect(hEle int, bEnable bool) int {
	r, _, _ := xEidtor_EnableAutoMatchSpaseSelect.Call(uintptr(hEle), 炫彩工具类.BoolPtr(bEnable))
	return int(r)
}
...
func XEditor_SetBreakpoint(hEle int, iRow int, bActivate bool) bool {
	r, _, _ := xEditor_SetBreakpoint.Call(uintptr(hEle), uintptr(iRow), 炫彩工具类.BoolPtr(bActivate))
	return r != 0
}
...
func XEditor_ExpandAll(hEle int, bExpand bool) int {
	r, _, _ := xEditor_ExpandAll.Call(uintptr(hEle), 炫彩工具类.BoolPtr(bExpand))
	return int(r)
}
...
func XEditor_Expand(hEle int, iRow int, bExpand bool) int {
	r, _, _ := xEditor_Expand.Call(uintptr(hEle), uintptr(iRow), 炫彩工具类.BoolPtr(bExpand))
	return int(r)
}
...
func XEditor_AddKeyword(hEle int, pKey string, iStyle int) int {
	r, _, _ := xEditor_AddKeyword.Call(uintptr(hEle), 炫彩工具类.StrPtr(pKey), uintptr(iStyle))
	return int(r)
}
...
func XEditor_AddConst(hEle int, pKey string) int {
	r, _, _ := xEditor_AddConst.Call(uintptr(hEle), 炫彩工具类.StrPtr(pKey))
	return int(r)
}
...
func XEditor_AddFunction(hEle int, pKey string) int {
	r, _, _ := xEditor_AddFunction.Call(uintptr(hEle), 炫彩工具类.StrPtr(pKey))
	return int(r)
}
...
func XEditor_AddExcludeDefVarKeyword(hEle int, pKeyword string) int {
	r, _, _ := xEditor_AddExcludeDefVarKeyword.Call(uintptr(hEle), 炫彩工具类.StrPtr(pKeyword))
	return int(r)
}

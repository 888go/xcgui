...
// hDraw:图形绘制句柄.
// fnPenStyle:画笔样式, PS_SOLID:线, PS_DASH:线, PS_DOT:线, PS_DASHDOT:线_点线, PS_DASHDOTDOT:线_点_点, PS_NULL:, PS_INSIDEFRAME:线_笔宽是向里EX.
// nWidth:画笔宽度.
// crColor:RGB颜色.

...
//	@return int 返回字体句柄.
func XFont_CreateEx(pName string, size int, style xcc.I常量_字体样式_) int {
...
//	@param style 字体样式, xcc.I常量_字体样式_.
//	@return int 返回炫彩字体句柄.
func XFont_CreateFromFile(pFontFile string, size int, style xcc.I常量_字体样式_) int {
...
//	@param style 字体样式: xcc.I常量_字体样式_.
//	@return int 返回炫彩字体句柄.
func XFont_CreateFromZip(pZipFileName, pFileName, pPassword string, fontSize int, style xcc.I常量_字体样式_) int {
...
//	@param style 字体样式: xcc.I常量_字体样式_.
//	@return int 返回炫彩字体句柄.
func XFont_CreateFromZipMem(data []byte, pFileName, pPassword string, fontSize int, style xcc.I常量_字体样式_) int {
...
//	@param style 字体样式, xcc.I常量_字体样式_.
//	@return int 返回字体句柄.
func XFont_CreateFromMem(data []byte, fontSize int, style xcc.I常量_字体样式_) int {
...
//	@param hModule xx.
//	@return int 返回炫彩字体句柄.
func XFont_CreateFromRes(id int, pType string, fontSize int, style xcc.I常量_字体样式_, hModule int) int {

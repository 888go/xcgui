...
func XAdTree_AddColumn(hAdapter int, pName string) int {
	r, _, _ := xAdTree_AddColumn.Call(uintptr(hAdapter), 炫彩工具类.StrPtr(pName))
	return int(r)
}
...
func XAdTree_SetColumn(hAdapter int, pColName string) int {
	r, _, _ := xAdTree_SetColumn.Call(uintptr(hAdapter), 炫彩工具类.StrPtr(pColName))
	return int(r)
}
...
func XAdTree_InsertItemText(hAdapter int, pValue string, nParentID int, insertID int) int {
	r, _, _ := xAdTree_InsertItemText.Call(uintptr(hAdapter), 炫彩工具类.StrPtr(pValue), uintptr(nParentID), uintptr(insertID))
	return int(r)
}
...
func XAdTree_InsertItemTextEx(hAdapter int, pName string, pValue string, nParentID int, insertID int) int {
	r, _, _ := xAdTree_InsertItemTextEx.Call(uintptr(hAdapter), 炫彩工具类.StrPtr(pName), 炫彩工具类.StrPtr(pValue), uintptr(nParentID), uintptr(insertID))
	return int(r)
}
...
func XAdTree_InsertItemImageEx(hAdapter int, pName string, hImage int, nParentID int, insertID int) int {
	r, _, _ := xAdTree_InsertItemImageEx.Call(uintptr(hAdapter), 炫彩工具类.StrPtr(pName), uintptr(hImage), uintptr(nParentID), uintptr(insertID))
	return int(r)
}
...
func XAdTree_SetItemText(hAdapter int, nID int, iColumn int, pValue string) bool {
	r, _, _ := xAdTree_SetItemText.Call(uintptr(hAdapter), uintptr(nID), uintptr(iColumn), 炫彩工具类.StrPtr(pValue))
	return r != 0
}
...
func XAdTree_SetItemTextEx(hAdapter int, nID int, pName string, pValue string) bool {
	r, _, _ := xAdTree_SetItemTextEx.Call(uintptr(hAdapter), uintptr(nID), 炫彩工具类.StrPtr(pName), 炫彩工具类.StrPtr(pValue))
	return r != 0
}
...
func XAdTree_SetItemImageEx(hAdapter int, nID int, pName string, hImage int) bool {
	r, _, _ := xAdTree_SetItemImageEx.Call(uintptr(hAdapter), uintptr(nID), 炫彩工具类.StrPtr(pName), uintptr(hImage))
	return r != 0
}
...
func XAdTree_GetItemTextEx(hAdapter int, nID int, pName string) string {
	r, _, _ := xAdTree_GetItemTextEx.Call(uintptr(hAdapter), uintptr(nID), 炫彩工具类.StrPtr(pName))
	return 炫彩工具类.UintPtrToString(r)
}
...
func XAdTree_GetItemImageEx(hAdapter int, nID int, pName string) int {
	r, _, _ := xAdTree_GetItemImageEx.Call(uintptr(hAdapter), uintptr(nID), 炫彩工具类.StrPtr(pName))
	return int(r)
}

...
func XAnima_Move(hSequence int, duration int, x float32, y float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_MoveEx(hSequence int, duration int, from_x float32, from_y float32, to_x float32, to_y float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_Rotate(hSequence int, duration int, angle float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_RotateEx(hSequence int, duration int, from float32, to float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_Scale(hSequence int, duration int, scaleX float32, scaleY float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_ScaleSize(hSequence int, duration int, width float32, height float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_Alpha(hSequence int, duration int, alpha uint8, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_AlphaEx(hSequence int, duration int, from_alpha uint8, to_alpha uint8, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_Color(hSequence int, duration int, color int, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_ColorEx(hSequence int, duration int, from int, to int, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_LayoutWidth(hSequence int, duration int, nType xcc.I常量_布局大小_, width float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_LayoutHeight(hSequence int, duration int, nType xcc.I常量_布局大小_, height float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_LayoutSize(hSequence int, duration int, nWidthType xcc.I常量_布局大小_, width float32, nHeightType xcc.I常量_布局大小_, height float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
func XAnimaScale_SetPosition(hAnimationScale int, position xcc.I常量_位置标识_) bool {
...
//
// bGoBack: 是否返回. 当启用后: 往返到起点, 起点->终点->起点.
func XAnima_DelayEx(hSequence int, duration float32, nLoopCount int, ease_flag xcc.I常量_缓动标识_, bGoBack bool) int {
...
//
// flags: 动画移动标识, 可组合使用, I常量_动画移动标识_.
//
// TODO: 此函数尚未封装到类中.
func XAnimaMove_SetFlag(hAnimationMove int, flags xcc.I常量_动画移动标识_) int {

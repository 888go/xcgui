...
func XTabBar_AddLabel(hEle int, pName string) int {
	r, _, _ := xTabBar_AddLabel.Call(uintptr(hEle), 炫彩工具类.StrPtr(pName))
	return int(r)
}
...
func XTabBar_InsertLabel(hEle int, index int, pName string) int {
	r, _, _ := xTabBar_InsertLabel.Call(uintptr(hEle), uintptr(index), 炫彩工具类.StrPtr(pName))
	return int(r)
}
...
func XTabBar_EnableTile(hEle int, bTile bool) int {
	r, _, _ := xTabBar_EnableTile.Call(uintptr(hEle), 炫彩工具类.BoolPtr(bTile))
	return int(r)
}
...
func XTabBar_EnableDropMenu(hEle int, bEnable bool) int {
	r, _, _ := xTabBar_EnableDropMenu.Call(uintptr(hEle), 炫彩工具类.BoolPtr(bEnable))
	return int(r)
}
...
func XTabBar_EnableClose(hEle int, bEnable bool) int {
	r, _, _ := xTabBar_EnableClose.Call(uintptr(hEle), 炫彩工具类.BoolPtr(bEnable))
	return int(r)
}
...
func XTabBar_ShowLabel(hEle int, index int, bShow bool) bool {
	r, _, _ := xTabBar_ShowLabel.Call(uintptr(hEle), uintptr(index), 炫彩工具类.BoolPtr(bShow))
	return r != 0
}

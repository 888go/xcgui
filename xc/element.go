...
// 元素_置坐标EX, 如果坐标未改变返回0, 如果大小改变返回2(触发XE_SIZE), 否则返回1.
// hEle:元素句柄    .元素句柄.
// x:X坐标.
// y:Y坐标.
// cx:宽度.
...
// 元素_取背景管理器EX, 获取元素背景管理器, 优先从资源中获取.
// hEle:元素句柄    .元素句柄.

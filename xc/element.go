...
func X元素_注册事件C(元素句柄 int, 事件类型 炫彩常量类.XE_, pFun interface{}) bool {
	r, _, _ := xEle_RegEventC.Call(uintptr(元素句柄), uintptr(事件类型), syscall.NewCallback(pFun))
	return r != 0
}
...
func X元素_注册事件C1(元素句柄 int, 事件类型 炫彩常量类.XE_, pFun interface{}) bool {
	r, _, _ := xEle_RegEventC1.Call(uintptr(元素句柄), uintptr(事件类型), syscall.NewCallback(pFun))
	return r != 0
}
...
func X元素_移除事件C(元素句柄 int, 事件类型 炫彩常量类.XE_, pFun interface{}) bool {
	r, _, _ := xEle_RemoveEventC.Call(uintptr(元素句柄), uintptr(事件类型), syscall.NewCallback(pFun))
	return r != 0
}
...
func X元素_注册事件CEx(元素句柄 int, 事件类型 炫彩常量类.XE_, pFun uintptr) bool {
	r, _, _ := xEle_RegEventC.Call(uintptr(元素句柄), uintptr(事件类型), pFun)
	return r != 0
}
...
func X元素_注册事件C1Ex(元素句柄 int, 事件类型 炫彩常量类.XE_, pFun uintptr) bool {
	r, _, _ := xEle_RegEventC1.Call(uintptr(元素句柄), uintptr(事件类型), pFun)
	return r != 0
}
...
func X元素_移除事件CEx(元素句柄 int, 事件类型 炫彩常量类.XE_, pFun uintptr) bool {
	r, _, _ := xEle_RemoveEventC.Call(uintptr(元素句柄), uintptr(事件类型), pFun)
	return r != 0
}
...
func X元素_发送事件(元素句柄 int, 事件类型 炫彩常量类.XE_, wParam, lParam uint) int {
	r, _, _ := xEle_SendEvent.Call(uintptr(元素句柄), uintptr(事件类型), uintptr(wParam), uintptr(lParam))
	return int(r)
}
...
func X元素_投递事件(元素句柄 int, 事件类型 炫彩常量类.XE_, wParam, lParam uint) int {
	r, _, _ := xEle_PostEvent.Call(uintptr(元素句柄), uintptr(事件类型), uintptr(wParam), uintptr(lParam))
	return int(r)
}
...
func X元素_置坐标(元素句柄 int, 坐标 *RECT, 是否重绘 bool, 调整布局标识位 炫彩常量类.AdjustLayout_, nAdjustNo uint32) int {
	r, _, _ := xEle_SetRect.Call(uintptr(元素句柄), uintptr(unsafe.Pointer(坐标)), 炫彩工具类.BoolPtr(是否重绘), uintptr(调整布局标识位), uintptr(nAdjustNo))
	return int(r)
}
...
func X元素_置坐标EX(元素句柄 int, 坐标 int, Y坐标 int, 宽度 int, 高度 int, 是否重绘 bool, 调整布局标识位 炫彩常量类.AdjustLayout_, nAdjustNo uint32) int {
	r, _, _ := xEle_SetRectEx.Call(uintptr(元素句柄), uintptr(坐标), uintptr(Y坐标), uintptr(宽度), uintptr(高度), 炫彩工具类.BoolPtr(是否重绘), uintptr(调整布局标识位), uintptr(nAdjustNo))
	return int(r)
}
...
func X元素_置逻辑坐标(元素句柄 int, 坐标 *RECT, 是否重绘 bool, 调整布局标识位 炫彩常量类.AdjustLayout_, nAdjustNo uint32) int {
	r, _, _ := xEle_SetRectLogic.Call(uintptr(元素句柄), uintptr(unsafe.Pointer(坐标)), 炫彩工具类.BoolPtr(是否重绘), uintptr(调整布局标识位), uintptr(nAdjustNo))
	return int(r)
}
...
func X元素_移动(元素句柄 int, 坐标, Y坐标 int32, 是否重绘 bool, 调整布局标识位 炫彩常量类.AdjustLayout_, nAdjustNo uint32) int {
	r, _, _ := xEle_SetPosition.Call(uintptr(元素句柄), uintptr(坐标), uintptr(Y坐标), 炫彩工具类.BoolPtr(是否重绘), uintptr(调整布局标识位), uintptr(nAdjustNo))
	return int(r)
}
...
func X元素_移动逻辑坐标(元素句柄 int, 坐标, Y坐标 int32, 是否重绘 bool, 调整布局标识位 炫彩常量类.AdjustLayout_, nAdjustNo uint32) int {
	r, _, _ := xEle_SetPositionLogic.Call(uintptr(元素句柄), uintptr(坐标), uintptr(Y坐标), 炫彩工具类.BoolPtr(是否重绘), uintptr(调整布局标识位), uintptr(nAdjustNo))
	return int(r)
}
...
func X元素_置拖动边框绑定元素(元素句柄 int, 边框位置标识 炫彩常量类.Element_Position_, hBindEle int, nSpace int) int {
	r, _, _ := xEle_SetDragBorderBindEle.Call(uintptr(元素句柄), uintptr(边框位置标识), uintptr(hBindEle), uintptr(nSpace))
	return int(r)
}
...
func X元素_添加背景边框(元素句柄 int, 组合状态 炫彩常量类.CombinedState, color int, width int) int {
	r, _, _ := xEle_AddBkBorder.Call(uintptr(元素句柄), uintptr(组合状态), uintptr(color), uintptr(width))
	return int(r)
}
...
func X元素_添加背景填充(元素句柄 int, 组合状态 炫彩常量类.CombinedState, color int) int {
	r, _, _ := xEle_AddBkFill.Call(uintptr(元素句柄), uintptr(组合状态), uintptr(color))
	return int(r)
}
...
func X元素_添加背景图片(元素句柄 int, 组合状态 炫彩常量类.CombinedState, hImage int) int {
	r, _, _ := xEle_AddBkImage.Call(uintptr(元素句柄), uintptr(组合状态), uintptr(hImage))
	return int(r)
}
...
func X元素_弹出工具提示(元素句柄 int, 坐标 int, Y坐标 int) int {
	r, _, _ := xEle_PopupToolTip.Call(uintptr(元素句柄), uintptr(坐标), uintptr(Y坐标))
	return int(r)
}
...
func X元素_调整布局EX(元素句柄 int, 调整标识 炫彩常量类.AdjustLayout_, nAdjustNo uint32) int {
	r, _, _ := xEle_AdjustLayoutEx.Call(uintptr(元素句柄), uintptr(调整标识), uintptr(nAdjustNo))
	return int(r)
}
...
func X元素_置大小(元素句柄 int, 宽度, 高度 int32, 是否重绘 bool, 调整布局标识位 炫彩常量类.AdjustLayout_, nAdjustNo uint32) int {
	r, _, _ := xEle_SetSize.Call(uintptr(元素句柄), uintptr(宽度), uintptr(高度), 炫彩工具类.BoolPtr(是否重绘), uintptr(调整布局标识位), uintptr(nAdjustNo))
	return int(r)
}

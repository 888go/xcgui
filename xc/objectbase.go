...
// XObj_GetTypeEx 炫彩对象_取类型EX, 获取对象EX类型, 返回对象EX类型:button_type_ , element_type_ , xc_ex_error.
// hXCGUI:对象句柄.
...
// XObj_SetTypeEx 炫彩对象_置类型EX, 如果是按钮, 请使用按钮的增强接口 XBtn_SetTypeEx().
// hXCGUI:对象句柄.
// nType:对象EX类型:button_type_ , element_type_ , xc_ex_error.

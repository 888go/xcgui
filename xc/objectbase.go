...
//
// hXCGUI: 对象句柄.
func XObj_GetType(hXCGUI int) 炫彩常量类.XC_OBJECT_TYPE {
...
//
// hXCGUI: 对象句柄.
func XObj_GetTypeEx(hXCGUI int) 炫彩常量类.XC_OBJECT_TYPE_EX {
...
func XObj_SetTypeEx(hXCGUI int, nType 炫彩常量类.XC_OBJECT_TYPE_EX) int {

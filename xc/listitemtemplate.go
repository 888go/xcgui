...
// 项模板_加载从资源ZIPEX. 加载列表项模板文件从RC资源ZIP, 返回模板句柄.
// nType:模板类型, xcc.ListItemTemp_Type_.
// id:RC资源ID.
// pFileName:模板文件名.
// pPassword:zip密码.
...
// 模板_加载从内存ZIPEX, 加载列表项模板从内存zip压缩包中.
// nType:模板类型, xcc.ListItemTemp_Type_.
// data:模板文件数据.
// pFileName:文件名.
// pPassword:zip密码.
